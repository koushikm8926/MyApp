...
import { Play, Sparkles, Lightbulb, Zap, ShieldCheck, ArrowLeft } from 'lucide-react-native';
      ...
      >
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.tipsSection}>
            ...
            <TipItem icon={Zap} text="Ensure the vehicle is in a well-lit area." color="#F59E0B" />
            <TipItem icon={ShieldCheck} text="Keep the camera steady for better results." color="#10B981" />
            <TipItem icon={Sparkles} text="Follow on-screen guides for accuracy." color="#0787e2" />
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
